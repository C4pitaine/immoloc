...
class Booking
{
    ...
    #[Assert\GreaterThan("today",message: "La date d'arrivée doit être ultérieur à la date d'aujourd'hui", groups:["front"])] // la date doit être plus grand qu'aujourd'hui
